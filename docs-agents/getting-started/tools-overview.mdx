...
DronaHQ Tools ecosystem has 5000+ powerful tools to help developers quickly build data-driven apps, integrate AI and databases, and automate workflows with ease.
...
| Google Search |Perform live searches on google search for web pages, images, videos, news, or places.|
...
| Delay | Wait for a specified duration (in seconds) before executing the next step. Useful for pacing external calls, waiting for side effects, or throttling workflows. Maximum delay is 60 seconds. |
